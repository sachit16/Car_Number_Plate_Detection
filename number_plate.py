...
harcascade = "C:/Users/sachi/OneDrive/Desktop/PW/Car number plate/Car-Number-Plates-Detection-main/model/haarcascade_russian_plate_number.xml"
...
while True:
    ...
    if cv2.waitKey(1) & 0xFF == ord('s'):
        ...
        cv2.imwrite("C:/Users/sachi/OneDrive/Desktop/PW/Car number plate/Car-Number-Plates-Detection-main/plates/scaned_img_" + str(count) + ".jpg", img_roi)
